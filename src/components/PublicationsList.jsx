    ...
    <section id="publications" className="space-y-6 pt-12 border-t border-slate-900">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Scientific journal articles with original computational physics, materials science, and biophysics figures.</p>
        </div>
        <a
            ...
            <div className="flex flex-col md:flex-row gap-6 items-start justify-between">
              <div className="space-y-2 flex-1">
                <div className="flex flex-wrap items-start justify-between gap-2">
                  <h3 className="font-bold text-slate-100 text-base flex-1">{pub.title}</h3>
